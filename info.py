...
# Bot pics
PICS = (environ.get('PICS', 'https://envs.sh/AGr.jpg')).split()
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002076925276').split()]
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Tamil_Mini')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Alan_Movies')
